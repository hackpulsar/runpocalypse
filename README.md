...
To build the project yourself first ```git clone``` it. Navigate into the directory you cloned into and run ```cmake -S. -B./build```. That will generate a ```build``` directory with a Makefile. Navigate there and run ```make```.
